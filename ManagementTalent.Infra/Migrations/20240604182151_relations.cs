        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assessments_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssessmentParamResults_AssessmentResults_AssessmentResultId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupParameters_Assessments_Id",
                        column: x => x.Id,
                        principalTable: "Assessments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupParameters_JobRoles_JobRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobParameterBases_GroupParameters_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobParameterBaseId1 = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    JobParameterBaseId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobParameterSeniority", x => new { x.JobParameterBaseId1, x.SeniorityId });
                    table.ForeignKey(
                        name: "FK_JobParameterSeniority_JobParameterBases_JobParameterBaseId1",
                        column: x => x.JobParameterBaseId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssessmentParamResults_AssessmentResultId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupParameters_JobRoleId",
